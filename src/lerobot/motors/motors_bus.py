...
class MotorsBus(abc.ABC):
    ...
    def sync_read(
        ...
        *,
        ...
        err_msg = f"Failed to sync read '{data_name}' on {ids=} after {effective_retry + 1} tries."
        ids_values, _ = self._sync_read(
            addr, length, ids, num_retry=effective_retry, raise_on_error=True, err_msg=err_msg
        )
